...
function getTitle() {
	// title
	echo "Olympic Archery || Stabilizers";
}
...
<?php if (isset($_SESSION['logged_in_user']) OR isset($_SESSION['admin'])){ ?>
	<div class="container-fluid my-4">
		<h1 class="head">STABILIZERS</h1>
		<?php 
			$sql = "SELECT id,name,price,description,image FROM products WHERE category_id = 2";
			...
			while($row = mysqli_fetch_assoc($all)) {
				...
				<h5 class="big">&nbsp;$<?php echo $price ?></h5><br>
				<h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $desc ?></h4>
				...
				<button data-id="<?php echo $prodid ?>" data-user="<?php echo $_SESSION['usernum'] ?>" class="btn btn-danger mb-4 order">Add to cart</button>
