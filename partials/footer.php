<div class="footer">
  ...
  <div class="navs py-2">
    <p id="nav1"><a href="index.php" title="Home">HOME</a> <a href="about.php" title="About">ABOUT</a> <a href='contact.php' title="Contact">CONTACT</a></p>
    <p>- &copy; BOWFLEXER 2018 - ALL RIGHTS RESERVED - <a href="/" title="Disclaimer" data-toggle="modal" data-target="#disclaimer">DISCLAIMER</a></p>
  </div>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" id="disclaimer1">
      ...
      <div class="modal-body">
        <h5 style="color: #E92E2E; font-family: 'Roboto Condensed',sans-serif;'">"THIS SITE IS STRICTLY MADE FOR TRAINING PURPOSES. THIS ONLY SHOWS MY SKILLS AND IS NOT USED AS AN OFFICIAL SITE. ALL ELEMENTS THAT ARE GRABBED AND USED FROM OTHER SITES IS SUBJECT FOR REMOVAL IF THE OWNER WISHES TO DO SO."</h5>
